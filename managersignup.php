<html>
  ...
  <head>
    <title> Manager Signup |  Red  chilliZ</title>
  ...
  <body style = "background:url( images/j5.jpg)">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="
              " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Sign Up <span class="caret"></span> </a>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> Red chilliZ</span></h1>
     <br>
  ...
  <br>
  <p>  Copyright &copy 2020 Red chilliZ.All rights reserved. </p>
  <br>
  </footer>
</html>
...
<html>
  ...
  <head lang="en">
    <title> Explore |  Red  chilliZ</title>
...
$count++;
if($count==4) 
 /**If there are more than four items that are enabled.While displaying ,after the fourth item create a new row **/
{                        
  echo "</div>";           
  $count=0;
}
...
else    /*If the number of foods that are enabled is 0. **/
{
  ?>

...
<html lang="en">
  ...
  <head>
    <title> Manager Login |  Red  chilliZ</title>
  ...
  <body style = "background:url( images/nivi5.jpg)">
...
if (!$success){
  echo '<p style="background-color:black; color:white;font-size:30px;"> This username is already taken.Please choose a different username.<a style="hover:grey" href="customersignup.php"> Click here to sign up </a></p>';
